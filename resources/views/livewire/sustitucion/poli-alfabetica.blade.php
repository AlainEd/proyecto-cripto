<div>
    <div
        ...
        <h1 class="mt-8 text-2xl font-medium text-gray-900 dark:text-white">
            Sustitución poli-alfabetica
        </h1>

        <p class="mt-4 text-gray-600 dark:text-gray-400">
            En la criptografía, un cifrado polialfabético es un cifrado basado en la sustitución de un carácter de texto
            por otro, mediante un sistema de sustitución que utiliza varios alfabetos diferentes. El cifrado
            polialfabético es un cifrado de sustitución múltiple, es decir, un cifrado en el que se utilizan varios
            alfabetos simples para cifrar el mensaje.
        </p>
