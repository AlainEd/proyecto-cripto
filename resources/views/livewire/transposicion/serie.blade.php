<div>
    <div
        ...
        <p class="mt-4 text-gray-600 dark:text-gray-400">
            La transposición por series es un método de cifrado que consiste en dividir el mensaje en grupos de un
            tamaño determinado y luego reordenar los caracteres de cada grupo. El orden de los caracteres se determina
            mediante una clave que se aplica a cada grupo.
        </p>
                    ...
                    <div class="flex flex-col lg:flex-row">
                        ...
                        <div class="w-full lg:w-1/2 lg:pl-4 mt-4 lg:mt-0">
                            <div class="flex flex-col">
                                ...
                                <div class="mt-1">
                                    <input wire:model="claveSerieSinCifrar" type="text" name="key"
                                        id="key"
                    ...
                    <div class="flex flex-col lg:flex-row">
                        ...
                        <div class="w-full lg:w-1/2 lg:pl-4 mt-4 lg:mt-0">
                            <div class="flex flex-col">
                                ...
                                <div class="mt-1">
                                    <input wire:model="claveSerieCifrado" type="text" name="claveSerieCifrado"
                                        id="claveSerieCifrado"
                                        class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:text-gray-200 rounded-md">
                                    @error('claveSerieCifrado')
                                        <span class="text-red-500">{{ $message }}</span>
                                    @enderror
                                </div>
                            </div>
