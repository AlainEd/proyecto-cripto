<div>
    <div
        ...
        <h1 class="mt-8 text-2xl font-medium text-gray-900 dark:text-white">
            Transposicion por Zig Zag
        </h1>

        <p class="mt-4 text-gray-600 dark:text-gray-400">
            La transposición por zig zag es un método de cifrado que consiste en escribir el mensaje a cifrar en un
            papel en forma de zig zag, y luego leerlo en línea recta. Para descifrarlo, se hace el proceso inverso.
        </p>
                    ...
                    <div class="flex flex-col lg:flex-row">
                        ...
                        <div class="w-full lg:w-1/2 lg:pl-4 mt-4 lg:mt-0">
                            <div class="flex flex-col">
                                ...
                                <div class="mt-1">
                                    <input wire:model="lineasSinCifrar" type="number" name="key"
                                        id="key"
                    ...
                    <div class="flex flex-col lg:flex-row">
                        ...
                        <div class="w-full lg:w-1/2 lg:pl-4 mt-4 lg:mt-0">
                            <div class="flex flex-col">
                                ...
                                <div class="mt-1">
                                    <input wire:model="lineasCifrado" type="text" name="lineasCifrado"
                                        id="lineasCifrado"
                                        class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:text-gray-200 rounded-md">
                                    @error('lineasCifrado')
                                        <span class="text-red-500">{{ $message }}</span>
